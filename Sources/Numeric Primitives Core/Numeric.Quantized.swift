...
extension Numeric.Quantized {
    ...
    ///
    /// Enables quantized operators to work with an arbitrary BinaryFloatingPoint
    /// scalar without requiring a same-type constraint.
    @inlinable
